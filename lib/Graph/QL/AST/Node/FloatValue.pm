...
sub BUILD ($self, $params) {
    ...
    throw('The `value` must be of type(float), not `%s`', $self->{value})
        unless assert_type_language_literal( $self->{value}, 'float' );
    
}

sub value : ro;

sub parsed_value ($self) { GraphQL::Util::Literals::parse_float( $self->value ) }
