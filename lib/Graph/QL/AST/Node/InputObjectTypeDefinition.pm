package Graph::QL::AST::Node::InputObjectTypeDefinition;
...
sub BUILD ($self, $params) {
    ...
    if ( $self->{fields}->@* ) {
        foreach ( $self->{fields}->@* ) {
            Carp::confess('The values in `fields` value must be an instance of `Graph::QL::AST::Node::InputValueDefinition`, not '.$_)
                unless Scalar::Util::blessed( $_ )
