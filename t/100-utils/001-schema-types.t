...
is(
    $non_null_list_non_null_Foo->ast,
    Graph::QL::Util::Schemas->construct_type_from_name($NON_NULL_LIST_NON_NULL_FOO)->ast,
...
is(
    $list_non_null_Foo->ast,
    Graph::QL::Util::Schemas->construct_type_from_name($LIST_NON_NULL_FOO)->ast,
    '... got the same underlying ASTs'
);
...
is(
    $non_null_Foo->ast,
    Graph::QL::Util::Schemas->construct_type_from_name($NON_NULL_FOO)->ast,
    '... got the same underlying ASTs'
);
...
is(
    $Foo->ast,
    Graph::QL::Util::Schemas->construct_type_from_name($FOO)->ast,
    '... got the same underlying ASTs'
);
